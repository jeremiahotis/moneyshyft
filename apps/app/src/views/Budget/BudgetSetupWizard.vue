...
import type { SavePreferencesData, WizardAnswers } from '@/types';
...
async function handleIncomeNext(data: { sources: WizardAnswers['income_sources'] }) {
  wizardStore.updateAnswers({ income_sources: data.sources });
  wizardStore.nextStep();
}

async function handleHousingNext(data: Partial<WizardAnswers>) {
  wizardStore.updateAnswers(data);
  wizardStore.nextStep();
}

async function handleTransportationNext(data: Partial<WizardAnswers>) {
  wizardStore.updateAnswers(data);
  wizardStore.nextStep();
}

async function handleUtilitiesNext(data: Partial<WizardAnswers>) {
  wizardStore.updateAnswers(data);
  wizardStore.nextStep();
}

async function handleDebtNext(data: Partial<WizardAnswers>) {
  wizardStore.updateAnswers(data);
  wizardStore.nextStep();
}

async function handleFlexibleNext(data: Partial<WizardAnswers>) {
  wizardStore.updateAnswers(data);
  wizardStore.nextStep();
}

async function handleExtraMoneyNext(data: SavePreferencesData | null) {
  if (data) {
