...
async function loadPaymentHistory() {
  ...
  try {
    ...
    error.value = getApiErrorMessage(err, 'Failed to load payment history');
  } finally {
...
async function handleAddPayment() {
  ...
  try {
    ...
    error.value = getApiErrorMessage(err, 'Failed to record payment. Please try again.');
  } finally {
  ...
  undoStore.schedule({
    ...
    onCommit: async () => {
      try {
        ...
        error.value = getApiErrorMessage(err, 'Failed to delete debt. Please try again.');
