...
export const useTransactionsStore = defineStore('transactions', () => {
  ...
  async function fetchTransactions(params?: {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch transactions');
      throw err;
    } finally {
  ...
  async function createTransaction(data: CreateTransactionData): Promise<TransactionCreateResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to create transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateTransaction(id: string, data: Partial<CreateTransactionData>): Promise<Transaction> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteTransaction(id: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function clearTransaction(id: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to clear transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function splitTransaction(id: string, splits: SplitData[]): Promise<SplitResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to split transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function getSplits(id: string): Promise<SplitResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to get split details');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateSplits(id: string, splits: SplitData[]): Promise<SplitResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update splits');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function unsplitTransaction(id: string, categoryId?: string | null): Promise<Transaction> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to unsplit transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
