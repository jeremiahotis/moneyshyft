...
export const useAssignmentsStore = defineStore('assignments', () => {
  ...
  async function fetchAssignments(month: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch assignments');
      throw err;
    } finally {
  ...
  async function createAssignment(data: CreateAssignmentData): Promise<IncomeAssignment> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to create assignment');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function autoAssign(incomeTransactionId: string): Promise<AutoAssignmentResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to auto-assign');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteAssignment(id: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete assignment');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function getTransactionAssignments(transactionId: string): Promise<IncomeAssignment[]> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch transaction assignments');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function transferMoney(data: {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to transfer money');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function assignToCategories(
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to assign to categories');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function autoAssignAll(month: string): Promise<AutoAssignmentResult> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to auto-assign all');
      throw err;
    } finally {
      isLoading.value = false;
    }
