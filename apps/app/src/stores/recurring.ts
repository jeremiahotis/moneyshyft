...
export const useRecurringStore = defineStore('recurring', () => {
  ...
  async function fetchRecurring(): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch recurring transactions');
      throw err;
    } finally {
  ...
  async function getRecurring(id: string): Promise<RecurringTransaction> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch recurring transaction');
      throw err;
    }
  }
  ...
  async function createRecurring(data: CreateRecurringData): Promise<RecurringTransaction> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to create recurring transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateRecurring(id: string, data: UpdateRecurringData): Promise<RecurringTransaction> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update recurring transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteRecurring(id: string): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete recurring transaction');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function toggleAutoPost(id: string): Promise<RecurringTransaction> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to toggle auto-post');
      throw err;
    }
  }
  ...
  async function generateInstances(id: string, daysAhead: number = 30): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to generate instances');
      throw err;
    }
  }
  ...
  async function fetchPendingInstances(daysAhead: number = 7): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch pending instances');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function fetchAllInstances(status?: string): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch instances');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function approveInstance(id: string): Promise<RecurringTransactionInstance> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to approve instance');
      throw err;
    }
  }
  ...
  async function skipInstance(id: string, data?: SkipInstanceData): Promise<RecurringTransactionInstance> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to skip instance');
      throw err;
    }
  }
  ...
  async function postInstance(id: string): Promise<RecurringTransactionInstance> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to post instance');
      throw err;
    }
  }
  ...
  async function updateInstance(id: string, data: UpdateInstanceData): Promise<RecurringTransactionInstance> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update instance');
      throw err;
    }
  }
  ...
  async function batchApprove(ids: string[]): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to batch approve instances');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function fetchPreferences(): Promise<void> {
    try {
      ...
      if (!axios.isAxiosError(err) || err.response?.status !== 404) {
        error.value = getApiErrorMessage(err, 'Failed to fetch preferences');
      }
    }
  }
  ...
  async function updatePreferences(data: Partial<UserPreferences>): Promise<void> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update preferences');
      throw err;
    }
  }
