...
export const useCategoriesStore = defineStore('categories', () => {
  ...
  async function createSection(data: {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to create section');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteCategory(categoryId: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete category');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteSection(sectionId: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete section');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateCategory(categoryId: string, data: {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update category');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateSection(sectionId: string, data: {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update section');
      throw err;
    } finally {
      isLoading.value = false;
    }
