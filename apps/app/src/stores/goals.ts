...
export const useGoalsStore = defineStore('goals', () => {
  ...
  async function fetchGoals(): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch goals');
      throw err;
    } finally {
  ...
  async function createGoal(data: CreateGoalData): Promise<Goal> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to create goal');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function updateGoal(id: string, data: UpdateGoalData): Promise<Goal> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to update goal');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function deleteGoal(id: string): Promise<void> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to delete goal');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function addContribution(goalId: string, data: AddContributionData): Promise<Goal> {
    ...
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to add contribution');
      throw err;
    } finally {
      isLoading.value = false;
    }
  ...
  async function getGoalContributions(goalId: string): Promise<GoalContribution[]> {
    try {
      ...
      error.value = getApiErrorMessage(err, 'Failed to fetch contributions');
      throw err;
    }
  }
